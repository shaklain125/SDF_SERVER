                    ...
                    if(sizeof($storesToList) == 0)
                    {
                      ...
                      foreach ($storesToList as $key1 => $value1) {
                        ...
                        foreach ($prefDiscountFromStore as $key => $value) {
                          ...
                          echo substr($value->getPercent().'% Off '.$value->getName(), 0, 80).(strlen($value->getPercent().'% Off '.$value->getName()) > 80?'...':'');
                          echo '</div>';
                        }
                ...
                function DisplayStoresNoPref($storesToList) {
                  ...
                  foreach ($storesToList as $key1 => $value1) {
                    ...
                    if(sizeof($d) > 0)
                    {
                      ...
                      echo substr($d->getPercent().'% Off '.$d->getName(), 0, 80).(strlen($d->getPercent().'% Off '.$d->getName()) > 80?'...':'');
                      echo '</div>';
                    }else {
                      echo '<div style="text-align:center;">';
                      echo 'Discounts N/A';
